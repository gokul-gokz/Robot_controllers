...
%% Implement the passivity controller for tracking a circle as trajectory in task space
options = odeset('RelTol',1e-4,'AbsTol',[1e-4, 1e-4, 1e-4, 1e-4]);
[T,X] = ode45(@(t,x) odepassivity(t,x,[I1,I2,m1,r1,m2,r2,l1,l2]),[0 tf],x0, options);
